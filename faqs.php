...
<body>
    ...
    <main style="max-width: 900px; margin: 40px auto; padding: 24px; background: #fff; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.07);">
        ...
        <h2>How do I reserve a lot?</h2>
        <p>To reserve a lot, simply <a href="userlot.php">view available lots</a> and click the Reserve button. You will need to log in or create an account.</p>
        <h2>What payment methods are accepted?</h2>
        <p>We accept bank transfer, GCash, and in-person payments at our office.</p>
        <h2>Can I schedule a site viewing?</h2>
        <p>Yes! Use the <a href="userlot.php">View Lots</a> or <a href="findagent.php">Find Agent</a> page to schedule a site visit with one of our agents.</p>
        <h2>Who do I contact for more information?</h2>
        <p>Visit our <a href="contact.php">Contact</a> page or message us on Facebook for assistance.</p>
    </main>
</body>
</html>
