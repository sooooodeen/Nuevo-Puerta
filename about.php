...
<body>
    ...
    <main style="max-width: 900px; margin: 40px auto; padding: 24px; background: #fff; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.07);">
        <h1>About El Nuevo Puerta Real Estate</h1>
        <p>Welcome to El Nuevo Puerta Real Estate! We are dedicated to helping you find your dream property, whether it's a spacious lot or a beautiful home. Our mission is to provide exceptional service and unmatched value to all our clients.</p>
        <h2>Our Vision</h2>
        <p>To be the leading provider of real estate solutions, offering prime locations, eco-friendly options, and hassle-free transactions.</p>
        <h2>Contact Us</h2>
        <p>For more information, please visit our <a href="contact.php">Contact</a> page or follow us on social media.</p>
    </main>
</body>
</html>
